...
public class Presenter implements Observer {
    ...
    public Presenter(Model model, View view, ViewBinary viewB) {
        System.out.println("DEBUG | PRESENTER  | Construction");
        this.model = model;
        this.view = view;
        this.viewBinary = viewB;
    }
    ...
    public void update(Observable observable, Object arg) {
        ...
        System.out.println("DEBUG | PRESENTER   | Ordonne à la vue binaire de se mettre a jour : l'entier vaut " + data);
