...
public class ViewModel implements Observer {
    ...
    private SimpleStringProperty valueBinary;
    ...
    public ViewModel(Model model) {
        ...
        this.valueBinary = new SimpleStringProperty();
    }
    ...
    public SimpleStringProperty getValueBinary() {
        return valueBinary;
    }
    ...
    public void update(Observable observable, Object arg) {
        ...
        valueBinary.set("" + Integer.toBinaryString(data));
    }
